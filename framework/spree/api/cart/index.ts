...
export type CartHandlers = {
  getCart: SpreeHandler<Cart, { cartId?: string }>
  addItem: SpreeHandler<Cart, { cartId?: string } & Partial<AddItemBody>>
  updateItem: SpreeHandler<
    Cart,
    { cartId?: string } & Partial<UpdateItemBody>
  >
  removeItem: SpreeHandler<
    Cart,
...
const cartApi: SpreeApiHandler<Cart, CartHandlers> = async (
  req,
  res,
  config,
  handlers
  ...
  try {
    ...
    const message =
      error instanceof SpreeApiError
